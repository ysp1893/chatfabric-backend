...
export ALLOWED_ORIGINS="${ALLOWED_ORIGINS:-http://192.168.24.30:$APP_PORT,http://localhost:$APP_PORT,http://127.0.0.1:$APP_PORT,http://192.168.24.30,http://192.168.24.30:4200,http://localhost:4200,http://127.0.0.1:4200}"
